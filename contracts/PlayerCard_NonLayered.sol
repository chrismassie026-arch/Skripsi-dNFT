...
contract PlayerCard_NonLayered is ERC721URIStorage, Ownable, FunctionsClient {
    ...
    string public sourceCode; // Kode JavaScript yang dieksekusi DON untuk memanggil API statistik

    // Variabel kontrol Chainlink Automation
    uint256 public lastTimeStamp;
    uint256 public constant MINIMUM_INTERVAL = 3600; // Batas minimum interval automasi: 1 jam
